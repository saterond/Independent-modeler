 ...
 */
public class ReturnMessageModelPersistenceDelegate extends DefaultPersistenceDelegate {
    ...
    protected Expression instantiate(Object oldInstance, Encoder out) {
        ReturnMessageModel rm = (ReturnMessageModel) oldInstance;
        return new Expression(
                oldInstance,
                oldInstance.getClass(),
                "new",
                new Object[]{rm.getName(), rm.getCell(), rm.getAssociateMessage()});
    }
