...
Conceptual/Business modeling is used in early stage of software/system development. Its purpose is to depict the basic business processes
...
Every class diagram has to be able to depict the basic elements of the class diagram as were described in section \ref{section:classDiagramDescription}.

TODO: Add the desired functionality + class diagram meta model.
